...
class PageLayoutViewDrawItem implements PageLayoutViewDrawItemHookInterface
{
    ...
    'cceexport_city_sign' => 'CitySign',
    'cceexport_driving_license_class' => 'DrivingLicenseClass',
    'cceexport_dsgvo' => 'Dsgvo',
    'cceexport_font_awesome' => 'FontAwesome',
    'cceexport_gallery' => 'Gallery',
    'cceexport_header_image' => 'HeaderImage',
    'cceexport_map' => 'Map',
    'cceexport_teaser' => 'Teaser',
    'cceexport_usp' => 'Usp',
];
    ...
    protected function configureView(array $pageTsConfig, $contentType)
    {
        ...
        if (!empty($previewConfiguration[$extensionKey]['templateRootPath'])) {
            $this->view->setTemplateRootPaths([
                'EXT:cceexport/Resources/Private/Backend/Templates/Content/',
